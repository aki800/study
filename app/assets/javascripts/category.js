$(document).on('turbolinks:load', function() {
  $(function() {
    ...
    function showMiddleCategories(category) {
      var html = `<div class = "categories__box", id = "middlecategory_${category.name}">
                    <div class= "categories__box__title">
                      <div class= "categories__box__title__text">
                        ${category.name}
                      </div>
                    </div>
                  </div>`
    ...
    function showFinalCategories(category) {
      var html = `<a href = "/categories/${category.id}/tweets", class = "categories__box", id = "middlecategory_${category.name}">
                    <div class = "categories__box__title">
                      <div class = "categories__box__title__text">
                        ${category.name}
                      </div>
